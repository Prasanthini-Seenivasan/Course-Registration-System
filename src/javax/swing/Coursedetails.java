 ...
 */
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(100, 40, 430, 32);
        ...
        jButton2.setBounds(450, 140, 110, 27);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "name", "mobile", "course", "payment", "amount"
            }
        ) {
        ...
        jScrollPane1.setBounds(60, 230, 585, 102);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            tm.setRowCount(0);
            while(RS.next()){
                Object o[]={RS.getString("name"),RS.getString("mobile"),RS.getString("course"),RS.getString("payment"),RS.getString("amount")};
                tm.addRow(o);
            }
        }
        catch (Exception e)
